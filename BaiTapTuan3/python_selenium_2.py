...
def get_all_information_to_excel(output_file = "Ma_So_Thue.xlsx"):
    ...
    try:
        ...
        for page in range(1, 5):
            ...
            for row in elements_rows:
                try:
                    ma_so_thue_value = "td:nth-child(2) > a"
                    element_ma_so_thue = row.find_element(By.CSS_SELECTOR, ma_so_thue_value)
                    ...
                    information_page_array.append({
                        "Mã số thuế": element_ma_so_thue.text,
...
if __name__ == "__main__":
    get_all_information_to_excel("Ma_So_Thue.xlsx")